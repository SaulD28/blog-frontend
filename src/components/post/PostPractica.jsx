...
import { usePostNewPractica } from "../../shared/hooks/useNewPostPractica";
import { useNavigate } from "react-router-dom";

const PostPractica = () => {
    const { posts: defaultPosts, loading, error } = useListPostPractica();
    const { posts: newPosts, loading: loadingNew, error: errorNew } = usePostNewPractica();
    ...
    return (
        <section className="max-w-4xl mx-auto px-4 py-6">
            <header className="text-center mb-6">
                <h1 className="text-3xl font-bold text-indigo-800">Posts de Práctica Supervisada</h1>
